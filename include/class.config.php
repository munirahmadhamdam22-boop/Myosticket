...
class OsticketConfig extends Config {
    ...
    var $defaults = array(
        ...
        'voice_msg_enabled' => true,
        'voice_msg_max_duration' => 120,
        'voice_msg_max_file_size' => 1048576,
        'voice_msg_allowed_formats' => 'webm,mp3,wav,ogg',
        'voice_msg_client_enabled' => true,
        'voice_msg_agent_enabled' => true,
    );
    ...
    function isVoiceMsgEnabled() {
        return ($this->get('voice_msg_enabled'));
    }

    function getVoiceMsgMaxDuration() {
        return $this->get('voice_msg_max_duration');
    }

    function getVoiceMsgMaxFileSize() {
        return $this->get('voice_msg_max_file_size');
    }

    function getVoiceMsgAllowedFormats() {
        return $this->get('voice_msg_allowed_formats');
    }

    function isVoiceMsgAllowedForClients() {
        return ($this->get('voice_msg_client_enabled'));
    }

    function isVoiceMsgAllowedForAgents() {
        return ($this->get('voice_msg_agent_enabled'));
    }
    ...
    function updateSystemSettings($vars, &$errors) {
        ...
        $f['voice_msg_max_duration']=array('type'=>'int', 'required'=>0, 'min'=>1, 'error'=>__('Invalid max recording duration'));
        $f['voice_msg_max_file_size']=array('type'=>'int', 'required'=>0, 'min'=>1024, 'error'=>__('Invalid max file size'));
        ...
        return $this->updateAll(array(
            ...
            'voice_msg_enabled' => isset($vars['voice_msg_enabled']) ? 1 : 0,
            'voice_msg_max_duration' => (int) $vars['voice_msg_max_duration'],
            'voice_msg_max_file_size' => (int) $vars['voice_msg_max_file_size'],
            'voice_msg_allowed_formats' => Format::sanitize($vars['voice_msg_allowed_formats']),
            'voice_msg_client_enabled' => isset($vars['voice_msg_client_enabled']) ? 1 : 0,
            'voice_msg_agent_enabled' => isset($vars['voice_msg_agent_enabled']) ? 1 : 0,
