...
<head>
    ...
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/voice.message.css?a1114e8" media="screen"/>
    ...
    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/voice.message.js?a1114e6"></script>
