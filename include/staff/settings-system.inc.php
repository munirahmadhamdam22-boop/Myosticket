...
<?php } ?>
        ...
        <tr>
            <td colspan="2" class="header"><?php echo __('Voice Messages'); ?></td>
        </tr>
        <tr>
            <td width="180"><?php echo __('Enable Voice Messages');?>:</td>
            <td>
                <input type="checkbox" name="voice_msg_enabled" <?php
                    if ($config['voice_msg_enabled']) echo 'checked="checked"';
                    ?> />
                <?php echo __('Allow voice message recording in tickets'); ?>
                <i class="help-tip icon-question-sign" href="#voice_msg_enabled"></i>
            </td>
        </tr>
        <tr>
            <td width="180"><?php echo __('Max Recording Duration');?>:</td>
            <td>
                <input type="text" name="voice_msg_max_duration" value="<?php
                    echo Format::htmlchars($config['voice_msg_max_duration']); ?>"/>
                <?php echo __('seconds'); ?>
                <i class="help-tip icon-question-sign" href="#voice_msg_max_duration"></i>
                <div class="error"><?php echo $errors['voice_msg_max_duration']; ?></div>
            </td>
        </tr>
        <tr>
            <td width="180"><?php echo __('Max File Size');?>:</td>
            <td>
                <input type="text" name="voice_msg_max_file_size" value="<?php
                    echo Format::htmlchars($config['voice_msg_max_file_size']); ?>"/>
                <?php echo __('bytes'); ?>
                <i class="help-tip icon-question-sign" href="#voice_msg_max_file_size"></i>
                <div class="error"><?php echo $errors['voice_msg_max_file_size']; ?></div>
            </td>
        </tr>
        <tr>
            <td width="180"><?php echo __('Allowed Formats');?>:</td>
            <td>
                <input type="text" name="voice_msg_allowed_formats" value="<?php
                    echo Format::htmlchars($config['voice_msg_allowed_formats']); ?>"/>
                <?php echo __('Comma-separated list of allowed audio formats (e.g. webm,mp3,wav,ogg)'); ?>
                <i class="help-tip icon-question-sign" href="#voice_msg_allowed_formats"></i>
                <div class="error"><?php echo $errors['voice_msg_allowed_formats']; ?></div>
            </td>
        </tr>
        <tr>
            <td width="180"><?php echo __('Client Voice Messages');?>:</td>
            <td>
                <input type="checkbox" name="voice_msg_client_enabled" <?php
                    if ($config['voice_msg_client_enabled']) echo 'checked="checked"';
                    ?> />
                <?php echo __('Allow clients to record and send voice messages'); ?>
                <i class="help-tip icon-question-sign" href="#voice_msg_client_enabled"></i>
            </td>
        </tr>
        <tr>
            <td width="180"><?php echo __('Agent Voice Messages');?>:</td>
            <td>
                <input type="checkbox" name="voice_msg_agent_enabled" <?php
                    if ($config['voice_msg_agent_enabled']) echo 'checked="checked"';
                    ?> />
                <?php echo __('Allow agents to record and send voice messages'); ?>
                <i class="help-tip icon-question-sign" href="#voice_msg_agent_enabled"></i>
            </td>
        </tr>
    </tbody>
</table>
